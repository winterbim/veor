...
|---|---|---|
| Complete source parses and executable tests pass on Node 22 | `npm run check` | CAPTURED_PASS (55/55) |
...
| Secret broker (named handles, redacted persistence) | future P0.4 gate | PENDING |
